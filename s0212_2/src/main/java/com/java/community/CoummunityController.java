...
public class CoummunityController {
		...
		@ResponseBody // 데이터 전송 @RequestRestController
		@PostMapping("/community/api_data")
		public String api_data() throws Exception {
			//api 호출
		    String service_key = "jRdaYR86wEkj5USok7LxRDgo9yflcgxyPLqiuNZ5x%2B%2Bvo%2F5va5kLiFX6EdQGuJCEFcwCA0Ai%2B%2FQ6xpUIGmLowQ%3D%3D";
		    String web_url = "https://apis.data.go.kr/B551011/PhotoGalleryService1/galleryList1";
		    String page = "1";
		   
		    StringBuilder urlBuilder = new StringBuilder(web_url); /*URL StringBuilder : 같은 메모리에 데이터 추가*/ 
	        ...
	        URL url = new URL(urlBuilder.toString()); // StringBuilder는 문자열로 넣고 싶을 때 toString()
	        ...
	        StringBuilder sb = new StringBuilder(); // api데이터가 sb로 들어감
	        String line;
		...
		public String epilogue_view(String galContentId) {
			System.out.println(galContentId);
